...
RouteModel::Node *RoutePlanner::NextNode() {
    sort(open_list.begin(),open_list.end() ,[](const auto &F_1st ,const auto &S_2nd)
    {
      return F_1st -> h_value + F_1st -> g_value > S_2nd -> h_value + S_2nd -> g_value;
    });
...
void RoutePlanner::AStarSearch() {
    ...
    // TODO: Implement your solution here.
    /*RouteModel::Node *current_node = NULL;*/
